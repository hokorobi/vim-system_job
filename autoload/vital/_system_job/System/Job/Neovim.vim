...
execute join(['function! vital#_system_job#System#Job#Neovim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_system_job#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
